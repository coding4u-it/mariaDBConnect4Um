...
public class GestDBmyLite{
     ...
     * @param url url dek db
     */
    public GestDBmyLite(String nomeDB, String userDB, String passDB,String url){
        this.userDB=userDB;
        this.passDB=passDB;
        this.nomeDB=nomeDB;
        driver="com.mysql.cj.jdbc.Driver";
        this.urlDB="jdbc:mysql://"+url+"/"+nomeDB+"?zeroDateTimeBehavior=ConvertToNull";//evita errore sulle date nulle
